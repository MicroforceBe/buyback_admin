...
// Eén centrale status-union die matcht met je DB + admin extra "cancelled"
type Status =
  | 'new'
  | 'received_store'
  | 'label_created'
        ...
        <table className="w-full text-sm border border-gray-200">
          <thead className="bg-gray-50">
            <tr className="text-left text-gray-700">
              ...
              <th className="px-3 py-2 border-b border-gray-200 w-[260px]">
              ...
              >
                ...
                <td className="px-3 py-2 border-r border-gray-200 align-top">
                  <details className="group">
                    ...
                    <div className="mt-2 text-xs leading-5 space-y-1">
                      ...
                      <div><span className="text-gray-500">Huidige status: </span>{statusLabel(lead.status)}</div>
                      {lead.status === 'cancelled' && lead.cancel_reason && (
                        <div className="text-xs text-red-700">
                          Reden annulatie: {lead.cancel_reason}
                        </div>
                      )}
                    </div>
                  </details>
                ...
                <td className="px-3 py-2 align-top">
                  {(() => {
                    ...
                    // Download label URL in hetzelfde formaat als de mail:
                    // - als label_pdf_url al een http(s)-URL is → direct gebruiken
                    // - anders behandelen als parcel_id en via admin-route laten downloaden
                      ...
                      <div className="space-y-1">
                        ...
                        {isFinal || !canWriteLeads ? (
                          ...
                          >
                            ...
                            {/* Reden annulatie – verplicht als naar Geannuleerd */}
                            <div className="text-[11px] text-gray-600 space-y-1">
                              <label className="flex flex-col gap-0.5">
                                ...
                                <select
                                  name="cancel_reason"
                                  className="bb-select h-7 text-[11px] px-2"
                              ...
                              <p className="text-[10px] text-gray-400">
                                Dit veld is <strong>verplicht</strong> wanneer je de status
                                naar <strong>Geannuleerd</strong> zet.
                              </p>
                            </div>
                          </form>
                        )}
                        ...
                        <details className="mt-1 text-[11px]">
                          ...
                          <div className="pl-4 mt-1 flex flex-col gap-1">
                            {/* Traceer pakket – zelfde knopstijl als Download label */}
                            {hasTracking ? (
                              <a
                                href={trackingHref!}
                                target="_blank"
                            ...
                            {/* Download label – via admin-route als label_pdf_url geen volledige URL is */}
                            {labelHref && (
                              <a
                                href={labelHref}
                                target="_blank"
